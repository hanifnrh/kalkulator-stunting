    ...
    <div className="flex flex-col justify-center items-center w-full sm:w-4/5 p-10">
      <Card className="sm:p-10 w-full sm:w-4/5">
        <CardHeader className="flex justify-center items-center">
          <CardTitle className="green text-center">Kalkulator Stunting</CardTitle>
          <CardDescription className="text-center">Hitung z-score dan deteksi stunting</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...formMethods}>
        ...
        <CardFooter className='flex justify-center items-center'>
          <p className="text-gray-600 dark:text-gray-400 text-center">
            *Catatan: Data dan hasil berdasarkan standar WHO.
          </p>
        </CardFooter>
      </Card>
    </div>
